...
void create() {
  ::create();
  set("short", "The war-priests' Spell Training Room");
  set("long", 
"This is where war-priests study vast amounts of religious texts in order "
"to master the various spells available to them.\n");
  ...
  set_exits( ([ "east" : "/d/damned/guilds/join_rooms/war-priest_join" ]) );
