...
int weapon_wield() {
	...
	message("info", "You attempt to wield the powerful weapon of Owedquar, but as you do so it violently flashes with unspeakable energy and blasts you ferociously, instantly dropping your corpse to the floor!", this_player());
	message("info", "You attempt to wield the powerful weapon of Owedquar, but as you do so it violently flashes with unspeakable energy and forces you to drop it like a hot potato.", this_player());
