...
/*
    set_related_guilds(({ "nethermancer", "dark-paladin", }));
    //Other:      "enchanter", "elementalist", "elemental-mage", "arch-mage"
    set_odd_guilds(({ "tinker" }));
    set_hated_guilds(({ "fighter", "thief", }));
    set_no_guilds(({ "assassin", "cleric", "war-priest", "paladin", "chaotic-lord", "nightblade", "sword-mage",  }));
*/	
