...
void create() {
    ...
    set("long", "This is the infamous Mercenaries guild, where scoundrels of
all types train their fighting skills so they can be of use to their
employers. The sign of the Mercenary, a pair of crossed daggers, hangs
above the door to the north. \n");
  //  The "\n" is important at the end of the long desc.

  set_exits( ([ "west" : "/d/daybreak/room/dbvl1",
              "north" : ROOMS+"train_room" ]) );

  set("guildmaster", "/d/damned/guilds/mercenary/mon/merc_gm");
  //  The guildmaster is automatically cloned if no pc guildmaster is
  //  found.

  set_guild_obj("/d/damned/guilds/mercenary/obj/mercenary_obj");
  //  This file points to the guildmaster object.

  //  The following lines set the properties for the guild.

  set_property("base hp regen", 14);
