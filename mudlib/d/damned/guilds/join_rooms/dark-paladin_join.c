...
/*
    set_related_guilds(({ "necromancer", "chaotic-lord", }));
    //Other:      "fighter", "thief", "tinker",
    set_odd_guilds(({ "sword-mage", }));
    set_hated_guilds(({ "elementalist", "enchanter", "elemental-mage",   }));
    set_no_guilds(({ "cleric", "war-priest", "paladin", "arch-mage", "assassin", "nightblade", "nethermancer", "tinker" }));
*/	
