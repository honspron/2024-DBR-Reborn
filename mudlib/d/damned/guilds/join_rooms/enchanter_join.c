...
/*
    set_related_guilds(({ "tinker", "necromancer", "nethermancer", }));
    //Other:      "elementalist",  "elemental-mage", "arch-mage",
    set_odd_guilds(({ "cleric", "war-priest" }));
    set_hated_guilds(({ "fighter", "thief", }));
    set_no_guilds(({ "dark-paladin", "assassin", "nightblade", "paladin", "chaotic-lord", "sword-mage",  }));
*/
