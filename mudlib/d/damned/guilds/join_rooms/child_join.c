...
"4) Go back to #1\n"+
  ...
  add_exit("/d/damned/akkad/ak_tavern3", "east");
    ...
    //Other:      "elementalist", "enchanter", "cleric", "war-priest", "paladin", "arch-mage", "assassin", "nightblade", "necromancer", "elemental-mage", "fighter", "thief", "tinker", "nethermancer", "sword-mage", "dark-paladin",
