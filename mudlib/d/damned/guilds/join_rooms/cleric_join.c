...
/*
    set_related_guilds(({ "war-priest", "paladin", }));
    //Other:      "elementalist", "enchanter", "elemental-mage"
    set_odd_guilds(({ "thief", "tinker" }));
    set_hated_guilds(({ "arch-mage", "sword-mage", "fighter"}));
    set_no_guilds(({ "dark-paladin",  "assassin",  "nightblade", "necromancer", "nethermancer", "chaotic-lord" }));
*/
