...
/*  
    set_related_guilds(({ "thief", "assassin", }));
    //Other:      "tinker", "chaotic-lord", "sword-mage",  
    set_odd_guilds(({ "elementalist", "enchanter", "elemental-mage" }));
    set_hated_guilds(({ "fighter", "necromancer", "nethermancer", }));
    set_no_guilds(({ "dark-paladin", "arch-mage", "cleric", "war-priest", "paladin",  }));
*/	
