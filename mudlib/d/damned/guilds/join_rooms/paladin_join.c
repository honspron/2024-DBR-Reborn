...
/*
    set_related_guilds(({ "fighter", "war-priest", "cleric", }));
    //Other:      "arch-mage", "elementalist", "enchanter", "elemental-mage",  
    set_odd_guilds(({ "sword-mage" }));
    set_hated_guilds(({ "nightblade", "assassin", "tinker" }));
    set_no_guilds(({ "necromancer", "nethermancer", "dark-paladin", "chaotic-lord", "thief",  }));
*/	
