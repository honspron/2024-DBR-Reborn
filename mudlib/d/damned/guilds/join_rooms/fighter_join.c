...
/*
    set_related_guilds(({ "tinker", "thief" }));
    //Other:      "cleric", "war-priest", "paladin"
    set_odd_guilds(({ "enchanter", "chaotic-lord", "sword-mage", "assassin" }));
    set_hated_guilds(({ "elementalist", "necromancer"}));
    set_no_guilds(({ "dark-paladin", "arch-mage", "nightblade", "nethermancer", "elemental-mage",  }));
*/  
