...
/*
    set_related_guilds(({ "arch-mage", "elemental-mage", }));
    //Other:      "enchanter", "necromancer", "nethermancer", "chaotic-lord", "sword-mage"
    set_odd_guilds(({ "tinker", "thief" }));
    set_hated_guilds(({ "fighter", }));
    set_no_guilds(({ "dark-paladin", "assassin", "nightblade", "cleric", "war-priest", "paladin" }));
*/	
