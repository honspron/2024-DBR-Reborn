...
/*
    ...
    set_odd_guilds(({ "sword-mage", "arch-mage", "elementalist", }));
    set_hated_guilds(({ "chaotic-lord", "elemental-mage" }));
    set_no_guilds(({ "dark-paladin", "nethermancer", "necromancer", "nightblade", "assassin" }));
*/	
