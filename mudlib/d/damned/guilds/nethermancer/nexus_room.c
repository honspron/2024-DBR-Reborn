...
void create() {
    ...
    add_exit("/d/damned/guilds/nethermancer/skill_room", "north");
    add_exit("/d/damned/guilds/nethermancer/magic", "south");
}

void reset() {
    if(!present("nexus")) new("/d/damned/guilds/nethermancer/misc/guild_master_nexus.c")->move(this_object());
}
