...
void finish_work(object caster, object at, int power) {
	...
	ob->add_ac(350, "aether");
	ob->add_ac(350, "cold");
	ob->add_ac(350, "crushing");
	ob->add_ac(350, "cutting");
	ob->add_ac(350, "unholy");
	ob->add_ac(350, "disruption");
	ob->add_ac(350, "electricity");
	ob->add_ac(350, "fire");
	ob->add_ac(350, "holy");
	ob->add_ac(350, "impact");
	ob->add_ac(350, "impaling");
	ob->add_ac(350, "infernal");
	ob->add_ac(350, "plasma");
	ob->add_ac(350, "stress");
	ob->add_ac(350, "strike");
	ob->add_ac(350, "vacuum");
