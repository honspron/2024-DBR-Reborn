...
"typing 'help castle'.\n\n"+
sprintf("plot of land               %d gold (one free room!)\n", to_int(100000.0*currency_rate("gold")))+
sprintf("castle room                %d gold\n", to_int(95000.0*currency_rate("gold")))+
sprintf("wood door                  %d gold\n", to_int(20000.0*currency_rate("gold")))+
sprintf("iron door                  %d gold\n", to_int(51000.0*currency_rate("gold")))+
sprintf("steel door                 %d gold\n", to_int(100000.0*currency_rate("gold")))+
sprintf("reinforced door            %d gold\n", to_int(150000.0*currency_rate("gold")))+
sprintf("vault door                 %d gold\n", to_int(200000.0*currency_rate("gold")))+
"\n"
