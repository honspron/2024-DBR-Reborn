...
void create() {
  object ob;
   ...
   set("long","Karsten is a slender high-elf with deep grey hair and sharp features.");
   set_gender("female");
   set_body_type("human");
   set("race", "high-elf");
   ...
   set_languages(({"common", "stormspeak", "elvish", "yin", "dwarvish", "drow", "pix", "treefolk", "vr'krr", "middle-english","catfolk", "ogryn", "rachk", "gr'grr" }));
   set("storage room",ROOMS+"shop/magic_store");
   set("markup", 20);
