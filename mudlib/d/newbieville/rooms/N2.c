...
void create() {
    ...
    set("long", "Special Secret newbie room in this room you should type %^YELLOW%^'kill newbie'%^RESET%^ after he dies you should do %^YELLOW%^'look corpse'%^RESET%^ and then %^YELLOW%^'get all from corpse'%^RESET%^ then go back to your original room and head up to choose your guild");
    add_exit("/d/newbieville/rooms/newbie3_u", "south");   
