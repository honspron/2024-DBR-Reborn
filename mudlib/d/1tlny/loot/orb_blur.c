...
void create() {
    ...
    set_long("This is a perfectly spherical glowing orb approximately nine inches in diameter. it appears like nothing but maybe if you did the commad%^YELLOW%^'orb blur'%^RESET%^somthing might happen\n");
    set_weight(10);
    set_value(1);
    return;
}
