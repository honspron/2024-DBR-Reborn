...
CLR= 20+random(199);
   ...
   set_short("A %^COLOR"+CLR+"%^rare%^RESET%^ ring of supreme "+zstat);
...
int extra_worn(){
   write("You feel the energy of the ring surge through your body. You feel a sensation of increaased "+zstat+" as you wear this ring");
...
int extra_remove(){
   write("You feel the energy of the ring releases from your body. You feel drained as your "+zstat+" is decreased");
  this_player()->add_stat_bonus(zstat, -(query_property("znum")));
    //TP->add_skill_bonus(skill1, -(query_property("znum")));
  return 1;
}
