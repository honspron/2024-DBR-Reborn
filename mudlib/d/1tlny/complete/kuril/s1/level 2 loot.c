...
switch(random(14)){
   ...
   set_name("dragon");
   set("id", ({ "dragon", "Dragon", "green dragon" }));
   set("long",
   ...
   set_short("["+zlevel+"]Medium Size%^GREEN%^Green%^RESET%^Dragon");
  ...
  // set_exp(6432454);
   ...
   set_stats("strength", 120 + zlevel);
   set_stats("dexterity", 120 + zlevel);
   set_stats("constitution", 120 + zlevel);
   set_stats("wisdom", 70 + zlevel);
   set_stats("intelligence", 70 + zlevel);
   set_stats("charisma", 70 + zlevel);
/*    
