...
if (loot == 14) {   
    ob = new("/d/damned/virtual/greate-ax_6.weapon");
    ob->move(this_object());
...
if (loot == 16) {  
//special GEAR DROP can cast divine transformation
    ob = new("/d/1tlny/loot/orb_divine_trans.c");
    ob->move(this_object());  
}
else {
