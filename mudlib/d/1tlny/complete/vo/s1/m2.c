...
switch(random(14)){
   ...
   set_level(zlevel);
   set_name("elder dragon");
   set("id", ({ "elder dragon", "dragon", "elder" }));
   set_short("["+zlevel+"]elder dragon");
   set("long",
	"You see a 1 thousand year old dragon you shake in your boots just looking at him!!");
