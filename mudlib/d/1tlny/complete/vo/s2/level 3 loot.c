...
switch(random(14)){
   ...
   set_name("dragon");
   set("id", ({ "dragon", "Dragon", "gold dragon" }));
   set("long",
   ...
   set_short("["+zlevel+"]Medium Size%^ORANGE%^Gold%^RESET%^Dragon");
  ...
  // set_exp(6432454);
   ...
   set_stats("strength", 140 + zlevel);
   set_stats("dexterity", 140 + zlevel);
   set_stats("constitution", 140 + zlevel);
   set_stats("wisdom", 90 + zlevel);
   set_stats("intelligence", 90 + zlevel);
   set_stats("charisma", 90 + zlevel);
/*    
