...
create() {
  ::create();
    ...
    set_name("guard");
    set_id( ({ "guard", "powerful guard", "rat", "powerful rat guard" }) );
    set_short("["+zlevel+"]Powerful Rat Guard");;
    set_long("A Guard stands before the door to the north exit");
...
*/
   ...
   ob = new("/d/damned/virtual/hammer_5.weapon");
   ob->move(this_object());
