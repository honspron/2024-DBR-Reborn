...
switch(random(7)){
   ...
   set_level(zlevel);
   set_name("dragon");
   set("id", ({ "dragon", "Dragon", "baby dragon", "baby purple dragon" }));
   set_short("["+zlevel+"]baby purple Dragon");
   set("long",
...
set_property("melee damage", ([
   ...
   set_hp(zlevel*100 + zlevel*2);
   set_max_hp(zlevel*100 + zlevel*2);
/*
   set_max_mp(7000);
   set_mp(7000);
*/
