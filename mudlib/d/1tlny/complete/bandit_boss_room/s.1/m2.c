...
switch(random(7)){
      ...
      case 7:quality="5";break;
    }

   set_level(zlevel);
   set_name("dragon");
   set("id", ({ "skeleton", "Skeleton", "strong skeleton", "strong tall skeleton" }));
   set_short("["+zlevel+"]strong tall skeleton");
   set("long",
...
if (loot == 16) {  
//special GEAR DROP can cast shocking grasp 
    ob = new("/d/1tlny/loot/orb_sgrasp");
    ob->move(this_object()); 
}	
else
if (loot == 17) {
