...
void create() {
   string var;
   ::create();
    set_money("silver", 1+random(14));
   set_name("rotting zombie");
   set("id", ({"zombie", "man"}) );
   set_level(14);
   switch(random(3)) {
           case 0: var = "pale looking man"; break;
           case 1: var = "skinless walking corpse"; break;
           case 2: var = "limping zombie"; break;
   }
   this_object()->set("short", "[14]"+var);
   set("long",
