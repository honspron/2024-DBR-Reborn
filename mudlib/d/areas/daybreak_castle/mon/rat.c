...
string rand_short;
  ...
  set("long","A disgusting flea-bitten rat. Careful it might have germs or even worse COVID-19!");
  set("race","rodent");
  ...
  set_skill("parry", 10);
   ...
   //ob->move(this_object()); 
  set("aggressive", 0);
  set_emotes(10, ({"The rat crawls from a crack between the bridge slats and skitters across the room",
