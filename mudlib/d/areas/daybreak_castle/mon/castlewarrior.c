...
int zlevel,xskill,roll,xchange,xname;
	...
	::create();
	set_name("castle warrior");
	set_id( ({"warrior", "castle warrior"}) );
	roll=random(10);
	switch(roll){
	case 0:zlevel=30;break;
	case 1:zlevel=30;break;
	case 2:zlevel=30;break;
	case 3:zlevel=31;break;
	case 4:zlevel=31;break;
	case 5:zlevel=31;break;
	case 6:zlevel=31;break;
	...
	xname=random(10);
	switch(xname) {
	case 0:xname="["+zlevel+"]Fearsome Castle warrior";break;
	case 1:xname="["+zlevel+"]Ferocious Castle warrior";break;
	case 2:xname="["+zlevel+"]Bloodthirsty Castle warrior";break;
	case 3:xname="["+zlevel+"]Feral Castle warrior";break;
	case 4:xname="["+zlevel+"]Angry Castle warrior";break;
	case 5:xname="["+zlevel+"]Overbearing Castle warrior";break;
	case 6:xname="["+zlevel+"]Powerful Castle warrior";break;
	case 7:xname="["+zlevel+"]Beast-like Castle warrior";break;

	case 8:xname="Large Castle warrior";break;
	case 9:xname="Strong Castle warrior";break;
}
	set_short(xname);
	set_long("Castle warriors are men who were abandoned and now defend the castle as if its their own.");
