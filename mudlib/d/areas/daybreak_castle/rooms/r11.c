...
It is dark and gloomy here.
	...
	%^WHITE%^(40-60+ Level)%^RESET%^
EndText);

    set( "night long", @EndText
It is dark and gloomy here.

    You are standing in the arch-way doorway. You can hear sounds of slithering from inside.
	
	%^WHITE%^(40-60+ Level)%^RESET%^
EndText);

//add_exit(PATH+"r3.c", "north");
add_exit(PATH+"r4.c", "northwest");
add_exit(PATH+"r25.c", "enter");
