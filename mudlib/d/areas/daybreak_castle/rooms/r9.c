...
It is dark and gloomy here.
	...
	%^WHITE%^(25-30+ Level)%^RESET%^
EndText);

    set( "night long", @EndText
It is dark and gloomy here.

    You are standing in the arch-way doorway. You can hear sounds of fire roaring from inside.
	
	%^WHITE%^(25-30+ Level)%^RESET%^
EndText);

add_exit(PATH+"r4.c", "southwest");
//add_exit(PATH+"r1.c", "bridge");
add_exit(PATH+"r48.c", "enter");
