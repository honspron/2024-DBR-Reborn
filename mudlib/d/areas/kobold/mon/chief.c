...
int zlevel;
   ...
   zlevel=(7+random(4));
if (zlevel == 7) set_short("[7]kobold chieftain");
else
if (zlevel == 8) set_short("[8]kobold chieftain");
else
if (zlevel == 9) set_short("[9]kobold chieftain");
else
if (zlevel == 10) set_short("[10]kobold chieftain");
else set_short("[11]kobold chieftain");
	set_level(zlevel);
   set("long",
