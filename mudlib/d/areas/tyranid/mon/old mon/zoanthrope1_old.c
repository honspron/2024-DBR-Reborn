...
// Wizard: Avatar
// Monster: Zoanthrope
// /wizards/avatar/tyranid/mon/zoanthrope1.c
// October 15th, 1996
...
void create()
{
    ...
    add_limb("atrophied arm one","",50,0,0);
    add_limb("atrophied arm two","",50,0,0);
    add_limb("atrophied leg one","",50,0,0);
    add_limb("atrophied leg two","",50,0,0);
    add_limb("atrophied leg three","",50,0,0);
    add_limb("atrophied leg four","",50,0,0);
    set_overall_ac(230);
}
...
void flash(object tp)
{
    ...
    */
    ...
    do_critical(this_object(),tp,"aether B");      
    cd = 2;
    return;
}
