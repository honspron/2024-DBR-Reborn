...
set_name("Painboyz");
   set("id", ({ "painboyz", "orc", "ork", "painboy", "mad doks", "doks" }));

 set("long",@ext Painboyz, known also as "Mad Doks" or "Doks", are responsible for fixing injuries even the highly regenerative Ork physiology cannot repair, such as severed limbs and brain damage.
ext);

    switch(random(3)){
      case 0:set_short("["+zlevel+"]Painboyz");break;
      case 1:set_short("["+zlevel+"]Mad Doks");break;
      case 2:set_short("["+zlevel+"]Doks");break;
}
