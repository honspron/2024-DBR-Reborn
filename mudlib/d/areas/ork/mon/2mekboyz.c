...
set_name("Mekboyz");
   set("id", ({ "mekboyz", "orc", "ork", "mekboy", "mekaniak", "mek" }));

 set("long",@ext A Mekboy, known also as a "Mekaniak" or simply as a "Mek", is a type of Oddboy who serves as one of the engineers and technicians who build all the weapons, vehicles, and other advanced technology used by the Greenskins.
ext);

    switch(random(3)){
      case 0:set_short("["+zlevel+"]Mekboyz");break;
      case 1:set_short("["+zlevel+"]Mekaniak");break;
      case 2:set_short("["+zlevel+"]Mek");break;
}
