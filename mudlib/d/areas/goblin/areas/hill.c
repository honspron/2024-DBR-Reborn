...
void create() {
	...
	set("long", @ext You are standing in front of what seems to be a large marble parthenon.  The parthenon has three passageways, to the north, northwest and northeast.  Intricate carvings of goblins fighting many other races, and running away from elves are depicted here.  In the north there seems to be an excessive amount of shouting and screaming.
  0 0 0  
   \|/    
    @
    |
