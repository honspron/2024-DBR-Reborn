...
void create() {
  object ob;
   ...
   ::create();
   set_name("marko");
   set("id", ({"marko", "shopkeeper", "shop keeper", "mark"}));
   add_money("gold", 5000);
   set_level(10);
   set_exp(3000000);
   ...
   set_hp(200000);
   set_max_hp(200000);
   set("short","Marko, Forger of Fine Blades");
   set("long",
"Marko is known throughout Munitio as the best weapon maker there is. He only deals in steel arms, though - iron is for cheapskates and suicidicals, he claims. He's a pretty burly-looking guy, and you doubt you'd want to mess with him.");
   set_gender("male");
   set_body_type("human");
   set("race", "human");
   ...
   set_languages(({"common", "stormspeak", "elvish", "serra", "yin", "dwarvish",
                "drow", "pix", "treefolk", "vr'krr", "middle-english",
		            "catfolk", "ogryn" }));
   set("storage room",ROOMS+"weapon_store");
   set("markup", 60);
