...
void create() {
    ...
    set("short", "The Hospital of Death");
    set("long",
	"A long time ago, this used to be a hospital run by the priests of Shard. Or so you guess. The only real indication of that is the hexagon of Lidfino which has miraculously stayed upon the southern wall. The rest of this place is destroyed, and has that scent of death even hundreds of years after the destruction.");
    set_items(
	(["hexagon" : "This is a universal symbol of peace. It didn't work too well, apparently.",
	  "scent" : "You don't look at scents, moron."
]));
    set_exits( 
              (["east" : ROOMS+"square" ]) );
	add_exit(ROOMS+"ak_bless3","north");
