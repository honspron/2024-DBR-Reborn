...
add_exit(ROOMS+"sewer5.c", "west");
add_exit(ROOMS+"sewer3.c", "south");
set("short", "City Sewers");
set("day long", "You are in the sewers of a once great city. Slug drips off the walls. A stream running through the room bring water out of the city. There is a light coming from the southern part of the tunnel. The tunnel makes a sharp turn to the west.");
set("night long", "You are in the sewers of a once great city. Slug drips off the walls. A stream running through the room bring water out of the city. The tunnel makes a sharp turn to the west.");
