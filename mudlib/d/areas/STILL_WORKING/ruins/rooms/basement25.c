...
add_exit(ROOMS+"basement24.c", "east");
...
the holes in the ceiling to let you see. You are standing at the end of a
small passage. The passage way continues east");
set("night long", "The Basement Of An Ancient House. This walls around you
are filled with cracks and chipped paint. The cieling is falling apart and
has alot of holes in it. You are standing at the end of a small passage.
The passage way continues east");
...
new(MON+"rat-man_champion.c")->move(this_object());
new(MON+"rat_guardf_key.c")->move(this_object());
}
