...
TP->add_quenched(5);
   ...
   switch(random(2)) {
case 0: drink = " shoves "+(string)TP->query_possessive()+ " grimy hands into the fountain and scoops up some water.  Even before "+(string)TP->query_name()+ " can finish "+(string)TP->query_possessive()+ " drink the water "+(string)TP->query_name()+ " contaminated was made crystal clear again.";
   break;
case 1: drink = " carefully reaches down and scoops up some water with "+(string)TP->query_possessive()+ " dirty hands.  Even before "+(string)TP->query_name()+ " can finish "+(string)TP->query_possessive()+ " drink the water "+(string)TP->query_name()+ " contaminated was made crystal clear again.";
   break;
}
   say(TPQCN+drink);
   return 1;
