...
message("info", "You carefully reach down and scoop up some of the green water with your hands. You spit out the water. 'EWWWWWW.... SEWAGE!!!'",
TP);
...
TP->add_poisoning(30);
   ...
   switch(random(2)) {
case 0: drink = " shoves "+(string)TP->query_possessive()+ " hands into the green water to take a drink. Then spits out the water.";
case 1: drink = " carefully reaches down and scoops up some of the green water with "+(string)TP->query_possessive()+ " hands. Then spits out the water.";
   break;
   break;
}
   say(TPQCN+drink);
