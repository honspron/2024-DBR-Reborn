...
create() {
    ...
    set_short("An undersized rat-man champion");
    set_long("This is one of the rat-man champions, his minscule size is a
disapointment to the symbol in his clan.  He wields a large axe that would
easily topple any normal rat-man trying to wield it. Funny how he can hold
it.");
        set_level(3);
set_body_type("rat");
        set("race", "rat");
