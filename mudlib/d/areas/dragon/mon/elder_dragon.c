...
set_name("dragon");
   set("id", ({ "dragon", "Dragon", "grey dragon", "elder dragon", "elder", "grey" }));
   set("long",
   ...
   set_short("["+zlevel+"]Elder %^RESET%^%^BLACK%^%^B_WHITE%^Grey%^RESET%^ Dragon");
 ...
 //set_max_hp(100);
    ...
    set_skill("martial arts", 3*zlevel+random(zlevel));
...
/*
    ...
    set_skill("elementalism", zspell*zlevel+random(zlevel));
    set_skill("electricity lore", zspell*zlevel+random(zlevel));
