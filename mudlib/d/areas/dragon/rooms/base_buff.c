...
void reset() {
	...
	while(i--)
	{
	    new(MON+"buff_dragon")->move(this_object());
	}
  }
}
...
void create(){
    ...
    set("long",
      "You press onwards, deeper into the dungeon's secrets. You pass dozens of similar rooms and passages, most of which look just like the other."
"\n"
#ifdef NORTHWEST
    "NW"
#endif
