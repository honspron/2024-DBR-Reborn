...
void create() {
    ...
    set("long",
	"You finally get around the large outcropping of rock and "
              "approach the back of the hill.  You hear a lot more motion "
              "coming from up the slope.  Maybe you are getting to the "
              "center of the insectoid activity.  Now if you only knew "
    ...
    set_exits((["northwest":HIV_ROOMS+"village_80.c",
                     "west":HIV_ROOMS+"village_90.c",
                     "southeast":HIV_ROOMS+"village_82.c"])); 
}
