...
void create() {
    ...
    set("long",
	"You are high enough on the west side of the hill to see "
              ...
              "don't think the insectoids will like you being here.\n" );
    set("night long",
    ...
    set_exits((["southeast":HIV_ROOMS+"village_97.c",
                     "east":HIV_ROOMS+"village_99.c",
                     "south":HIV_ROOMS+"village_96.c",
                     "northeast":HIV_ROOMS+"village_95.c",
                     "southwest":HIV_ROOMS+"village_88.c",
                     "north":HIV_ROOMS+"village_91.c"])); 
}
