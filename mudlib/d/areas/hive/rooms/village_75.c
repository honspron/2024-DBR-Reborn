...
void create() {
    ...
    set("long",
	"You are on the west side of the hill.  Perhaps the hill is not "
              "as well guarded from this direction, but you doubt it.  The "
              "insectoids seem efficient as well as dangerous.  You still "
              "find yourself winding your way through rocks and "
              "underbrush.\n" );
    set("night long",
    ...
    set_exits((["north":HIV_ROOMS+"village_76.c",
                     "east":HIV_ROOMS+"village_88.c",
                     "south":HIV_ROOMS+"village_74.c"])); 
}
