...
void create() {
    ...
    set("long",
	"The hill looks dangerous and forbidding.  You could easily "
              "get trapped or simply lost in the maze created by the "
              "underbrush and rocks.  And that ignores the threat of the "
              "hostile insectoids.\n" );
    set("night long",
    ...
    set_exits((["northwest":HIV_ROOMS+"village_89.c",
                     "northeast":HIV_ROOMS+"village_85.c",
                     "southwest":HIV_ROOMS+"village_69.c",
                     "west":HIV_ROOMS+"village_71.c"])); 
}
