...
void create() {
    ...
    set("long",
	"Large rocks block your movement toward the top of the "
              "hill.  However, it does look you can follow the edge of the "
              "hill toward the back.\n" );
    set("night long",
    ...
    set_exits((["north":HIV_ROOMS+"village_83.c",
                     "southwest":HIV_ROOMS+"village_85.c"])); 
}
