...
void create() {
    ...
    set("long",
	"You are at the rear of the hill, directly opposite to the "
              "approach from the village.  Although you can not see any "
              "details due to the pervasive rocks and underbrush, the "
              "entire hillside seems to be in subtle motion.  You can only "
             "guess that an entire insectoid colony has taken up "
             "temporary residence on the hill for some unknown reason.\n" );
    set("night long",
    ...
    set_exits((["southeast":HIV_ROOMS+"village_90.c",
                     "west":HIV_ROOMS+"village_78.c",
                     "east":HIV_ROOMS+"village_80.c",
                     "south":HIV_ROOMS+"village_95.c",
                     "southwest":HIV_ROOMS+"village_91.c"])); 
}
