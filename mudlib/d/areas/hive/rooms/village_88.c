...
void create() {
    ...
    set("long",
	"You move between two large rock outcroppings.  Between "
              "the rocks and the heavy underbrush, you cannot see very "
              "far.  As you examine your immediate surroundings, you "
              "note that the insectoids seem to be using this part of the "
              "hill to store some sort of food they seem to have brought "
              "with them.\n" );
    set("night long",
...
({ "forest" }) :
    ...
    set_exits((["southeast":HIV_ROOMS+"village_86.c",
                     "southwest":HIV_ROOMS+"village_74.c",
                     "northwest":HIV_ROOMS+"village_76.c",
                     "northeast":HIV_ROOMS+"village_93.c",
                     "west":HIV_ROOMS+"village_75.c",
                     "east":HIV_ROOMS+"village_96.c"])); 
}
