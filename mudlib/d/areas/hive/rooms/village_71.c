...
void create() {
    ...
    set("long",
	"The lower hill is crowded, cluttered with the large rocks.  "
              "On this side of the hill, however, you still have different "
              "options as to what direction you would like to move.  The "
              "insectoids seem to be centered near the top or back of the "
              "hill.\n" );
    set("night long",
    ...
    set_exits((["west":HIV_ROOMS+"village_70.c",
                     "north":HIV_ROOMS+"village_89.c",
                     "east":HIV_ROOMS+"village_72.c",
                     "south":HIV_ROOMS+"village_69.c"])); 
}
