...
void create() {
	...
	"The lower hill is crowded, cluttered with the large rocks "
              "that have rolled down the hill over time.  To make it "
              "worse, both trees and the undergrowth have good purchase "
              "here closer to the less rocky forest.\n" );
    set("night long",
    ...
    set_exits((["northwest":HIV_ROOMS+"village_73.c",
                     "northeast":HIV_ROOMS+"village_89.c",
                     "southeast":HIV_ROOMS+"village_69.c",
                     "east":HIV_ROOMS+"village_71.c"])); 
}
