...
void create() {
    ...
    set("short", "Northeast Wall");
    set("long",
	"You stand on northeast corner of the wall.  Over the wall, "
              ...
              "village.  The wall continues to the west and to the south.\n" );
    set("night long",
	"You stand on top of the northeast corner of the wall.  Over "
              ...
              "fire.  The wall continues to the west and to the south.\n" );
...
set_exits((["west":HIV_ROOMS+"village_107.c",
                 "south":HIV_ROOMS+"village_109.c"])); 
}
