...
void create() {
	...
	"You are high enough on the hill to see the nearby terrain "
              ...
              "retains its cover of rocks and underbrush.  You get the "
              "impression that the insectoids do not like people "
              "wandering around this part of the hill.  Well, not any part "
              "of the hill really.\n" );
    set("night long",
    ...
    set_exits((["west":HIV_ROOMS+"village_95.c",
                     "east":HIV_ROOMS+"village_81.c",
                     "south":HIV_ROOMS+"village_92.c",
                     "northwest":HIV_ROOMS+"village_79.c",
                     "southwest":HIV_ROOMS+"village_99.c",
                     "north":HIV_ROOMS+"village_80.c"])); 
}
