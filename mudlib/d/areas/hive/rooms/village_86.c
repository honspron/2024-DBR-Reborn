...
void create() {
	...
	"You have gotten pretty high up on the hill.  The immediate "
              ...
              "that it will last.  The insectoids has taken the hill over "
              "pretty thoroughly.  From here, there are large rock "
              "outcroppings to the west and the south, blocking off some "
              "of your movement options.\n" );
    set("night long",
    ...
    set_exits((["southeast":HIV_ROOMS+"village_89.c",
                     "southwest":HIV_ROOMS+"village_73.c",
                     "northwest":HIV_ROOMS+"village_88.c",
                     "northeast":HIV_ROOMS+"village_97.c",
                     "east":HIV_ROOMS+"village_94.c",
                     "north":HIV_ROOMS+"village_96.c"])); 
}
