...
void create() {
    ...
    set("short", "Southwest Wall");
    set("long",
	"You stand on southwest corner of the wall.  Over the wall, "
              "you can see the ancient forest over a short span of cleared "
              "ground.  Behind you, you see the tops of some of the "
              "buildings in the village.  The wall continues to the east and "
              "to the north.\n" );
    set("night long",
	"You stand on top of the southwest corner of the wall.  Over "
              ...
              "fire.  The wall continues to the east and to the north.\n" );
...
set_exits((["east":HIV_ROOMS+"village_114.c",
                 "north":HIV_ROOMS+"village_116.c"])); 
}
