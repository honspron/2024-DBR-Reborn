...
void create() {
    ...
    set("long",
	"You are at the back slope of the hill.  It is obvious that the "
              "insectoids have taken over the entire hill.  You can also "
              "tell that center of their activity is on the back side of the "
              "hill.\n" );
    set("night long",
    ...
    set_exits((["southwest":HIV_ROOMS+"village_95.c",
                     "west":HIV_ROOMS+"village_79.c",
                     "south":HIV_ROOMS+"village_90.c",
                     "southeast":HIV_ROOMS+"village_81.c"])); 
}
