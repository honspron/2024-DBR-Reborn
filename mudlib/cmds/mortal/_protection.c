...
tmp += DESC_COLOR[idx] + arrange_string(DESCS[idx]+" "+ac, 34);
      tmp += "%^RESET%^%^BLUE%^|\n";
    }
    tmp += "%^BLUE%^+---------------+---------------------------------------+\n";
  }
...
//TLNY2020 Change
tmp += "%^CYAN%^%^BOLD%^Physical: %^RESET%^" + DESC_COLOR[idx] + arrange_string(DESCS[idx]+" "+ac, 24);
      tmp += "%^RESET%^%^BLUE%^|\n";
      tmp += "%^BLUE%^|%^RESET%^ ";
      tmp += "%^YELLOW%^%^BOLD%^              ";
      tmp += "%^RESET%^%^BLUE%^|%^RESET%^ ";
...
//TLNY2020 ADD Change
tmp += "%^CYAN%^%^BOLD%^Magical: %^RESET%^" + DESC_COLOR[idx] + arrange_string(DESCS[idx]+" "+ac, 27);
      tmp += "%^RESET%^%^BLUE%^|\n";
    }
    tmp += "%^BLUE%^+---------------+---------------------------------------+\n";
  }
