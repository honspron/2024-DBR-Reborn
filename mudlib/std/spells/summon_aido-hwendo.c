...
#define ID ({"aido-hwendo", "serpent", "rainbow-serpent"})
// The creature's short desc
#define SHORT "a rainbow-colored aido-hwendo"
// The creature's long desc
#define LONG "The aido-hwendo is a serpent with scales in a rainbow of colors. He is rather large and mean-looking."
// The creature's race
#define RACE "serpent"
// The creature's body type
#define BODYTYPE "serpent"
