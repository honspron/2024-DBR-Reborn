...
#define ID ({"griffin", "flying lion"})
// The creature's short desc
#define SHORT "grand griffin"
// The creature's long desc
#define LONG "This is a creature that has the ears, body, hind legs, and tail of a lion, and the head, foreparts, and wings of an eagle. Griffins are said to be exceedingly strong, and their young are fed with human flesh."
// The creature's race
#define RACE "beast"
// The creature's body type
#define BODYTYPE "dragon"
