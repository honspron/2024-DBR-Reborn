...
#define FASTDEVCOST 195
// The spell's casting level
#define LEVEL 33
// The IDs of the creature
#define ID ({"ky-lin", "kylin", "beast"})
// The creature's short desc
#define SHORT "perfect-looking kylin"
// The creature's long desc
#define LONG "A kylin is a somehow perfect-looking beast with the head of a dragon bearing a single horn, the mane of a lion, the body of a stag, and the tail of an ox."
// The creature's race
#define RACE "beast"
// The creature's body type
#define BODYTYPE "quesour"
