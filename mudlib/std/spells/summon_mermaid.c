...
#define SHORT "beautiful mermaid"
// The creature's long desc
#define LONG "A mermaid is just like a regular human, except that they don't have legs. They've got a fish tail. This one is actually quite beautiful."
// The creature's race
#define RACE "merfolk"
