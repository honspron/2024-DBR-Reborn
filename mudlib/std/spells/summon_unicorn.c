...
#define SHORT "majestic unicorn"
// The creature's long desc
#define LONG "A unicorn is a horse with a horn. They're all white. For some reasons, virgins love them. Must be because of the horn."
// The creature's race
#define RACE "horse"
