...
#define ID ({"chimera", "beast", "abomination"})
// The creature's short desc
#define SHORT "powerful chimera"
// The creature's long desc
#define LONG "Fire-breathing she-monster, having the head of a lion, the body of a goat, and the tail of the serpent. It's real big!"
// The creature's race
#define RACE "beast"
