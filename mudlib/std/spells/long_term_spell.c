...
*/
  ...
  if(!query_in_progress(what)) {
    ...
    who_working->set_property("long term progress", 0);
    ...
    who->set_property("long term progress", (int)what->query_property("progress "+skill_name+"_"+worker_name));
...
*/
  ...
  who_working->set_property("long term progress", (string)working_on->query_property("progress "+skill_name+"_"+worker_name));
  if(time_to_go <= 0) {
