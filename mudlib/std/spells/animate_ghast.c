...
void create() {
    ...
    set_property("prereq", "animate ghoul");
...
void info() {
message("help",
"This spell animates a corpse into a ghast who will serve you as an undead thrall.  "
