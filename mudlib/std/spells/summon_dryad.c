...
#define ID ({"dryad", "hunter"})
// The creature's short desc
#define SHORT "gorgeous dryad"
// The creature's long desc
#define LONG "A dryad is one of a group of nymphs that presides over forests. They are extremely beautiful, and are powerful hunters to boot."
// The creature's race
#define RACE "human"
