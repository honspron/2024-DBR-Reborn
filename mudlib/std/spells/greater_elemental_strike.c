...
void create() {
    ::create();
    set_property("name","greater elemental strike");
    ...
    set_property("caster message","You cast a greater elemental strike!");
    set_property("target message","");
    set_property("observer message","$C casts a greater elemental strike.");
...
void info() {
message("help",
"This spell is the equivalent of firing 4 greater elemental bolts see 'help "
