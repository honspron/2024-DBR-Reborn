...
#define NAME "will o' the wisp"
// The type of creature (sky, water, earth, fire, magic)
#define TYPE "magic"
// The base MP cost
#define MPCOST 30
// The normal train dev cost
#define NORMALDEVCOST 17
// The fast train dev cost
#define FASTDEVCOST 60
// The spell's casting level
#define LEVEL 5
// The IDs of the creature
#define ID ({"will", "wisp", "spirit", "will o' the wisp"})
// The creature's short desc
#define SHORT "mysterious will o' the wisp"
// The creature's long desc
#define LONG "These odd creatures are strange, floating balls of light seen hovering in swamps, thought to be the souls of children who have died there."
// The creature's race
#define RACE "elemental"
// The creature's body type
#define BODYTYPE "sphere"
