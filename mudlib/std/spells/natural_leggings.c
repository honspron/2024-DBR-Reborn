...
void create() {
    ::create();
    set_property("name","natural leggings");
...
void info() {
message("help",
"This spell creates a set of powerful natural leggings from a Shaman Jewel. The power and type of the jewel determines protection values. This is a long-term spell (see help long-term), and it takes very much real time to cast.  The spell must be cast on a Shaman Jewel that is not made of obsidian or quartz.  If you are interrupted while casting, you may pick up again at a later time.\n",
this_player());
}
...
void finish_work(object caster, object at, int power) {
  ...
  message("info", "You finish the spell, and natural leggings appear.", caster);
  message("info", (string)caster->query_cap_name() + " stops yelling his beliefs, and some natural leggings of some sort appears.",
          environment(caster), ({ caster }) );
...
armour_set(at->query_material());
  ...
  seteuid(getuid());
  ob = new("/std/tailwind/obj/shaman_leggings");
