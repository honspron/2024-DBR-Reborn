...
#define ID ({"cockatrice", "cock", "chicken"})
// The creature's short desc
#define SHORT "crazy cockatrice"
// The creature's long desc
#define LONG "The cockatrice is a serpent born from a cock's egg that had the power to kill from its glance and breath. It has the upper body of a rooster and the lower body of a snake.."
// The creature's race
#define RACE "bird"
