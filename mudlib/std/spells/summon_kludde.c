...
#define ID ({"kludde", "munchkin", "faerie"})
// The creature's short desc
#define SHORT "nervous kludde"
// The creature's long desc
#define LONG "A kludde is a little shape-shifting faerie that loves to cause trouble."
// The creature's race
#define RACE "sprite"
