...
#define ID ({"leprechaun", "munchkin", "faerie"})
// The creature's short desc
#define SHORT "greedy leprechaun"
// The creature's long desc
#define LONG "A leprechaun is a faerie that is quite greedy and easily upset. He is dressed in green with a leather apron, silver-buckled shoes, and a red cap."
// The creature's race
#define RACE "sprite"
