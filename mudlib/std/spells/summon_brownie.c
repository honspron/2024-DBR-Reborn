...
#define NORMALDEVCOST 50
// The fast train dev cost
#define FASTDEVCOST 130
// The spell's casting level
#define LEVEL 13
// The IDs of the creature
#define ID ({"brownie", "munchkin", "faerie"})
// The creature's short desc
#define SHORT "cute brownie"
// The creature's long desc
#define LONG "A brownie is a small, generally friendly faerie that helps around the house with chores. It tends to favor a member of the household over the others and takes care to please that person."
// The creature's race
#define RACE "sprite"
// The creature's body type
#define BODYTYPE "human"
