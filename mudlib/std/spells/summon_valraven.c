...
#define ID ({"valraven", "raven"})
// The creature's short desc
#define SHORT "depressing valraven"
// The creature's long desc
#define LONG "A valraven is a jet black raven the size of a horse. It amazes you that it can even fly."
// The creature's race
#define RACE "bird"
