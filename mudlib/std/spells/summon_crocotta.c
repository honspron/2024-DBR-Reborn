...
#define ID ({"wolf", "dog", "dog wolf", "wolf dog", "dog-wolf", "wolf-dog"})
// The creature's short desc
#define SHORT "strange crocotta"
// The creature's long desc
#define LONG "A crocotta is a cross between a dog and a wolf. He has huge teeth that can bite through anything, including you."
// The creature's race
#define RACE "wolf"
