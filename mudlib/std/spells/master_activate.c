...
void create() {
    ::create();
    set_property("name","master weapon");
    ...
    set_property("caster message","You master $T as your own.");
    set_property("target message","");
    set_property("observer message","$C casts mastered weapon at $T.");
