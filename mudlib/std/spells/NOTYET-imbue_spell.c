...
void create() {
    ...
    set_property("fast dev cost", 765);
...
"***This is a very powerful spell and only the most dedicated enchanters may use it. A skill of 225% is needed to cast this spell. And a base skill of 200% to train it.***\n"
...
void spell_func(object caster, object at, int power, string args, int flag) {
  ...
  if((int)caster->query_skill("enchantment") < 225 ) {
...
//          spell_lev * spell_lev * 2500);
	caster->add_exp2(spell_lev * 6500 * power);
  remove();
  return;
}
