...
#define ID ({"alu", "horror", "body"})
// The creature's short desc
#define SHORT "terrifying alu"
// The creature's long desc
#define LONG "Alus are spirits which take the form of limbless bodies. They float in midair, and attack by trying to consume the target."
// The creature's race
