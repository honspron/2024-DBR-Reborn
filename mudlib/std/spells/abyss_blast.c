...
set_property("damage types", ([ "unholy" : 90+this_player()->query_level(), "infernal" : 90+this_player()->query_level(), "disruption" : 90+this_player()->query_level() ]));
set_property("damage multiplier", 15+this_player()->query_level() );
