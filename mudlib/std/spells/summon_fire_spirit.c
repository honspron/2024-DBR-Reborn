...
#define ID ({"spirit", "fire spirit", "fire-spirit"})
// The creature's short desc
#define SHORT "fire spirit"
// The creature's long desc
#define LONG "Fire spirits are just big balls of flame that serve as pets."
// The creature's race
