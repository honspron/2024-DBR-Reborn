...
#define ID ({"makara", "crocodile", "beast"})
// The creature's short desc
#define SHORT "odd makara"
// The creature's long desc
#define LONG "This creature is half-antelope and half-crocodile. You can only guess as to why it's floating around and making noise."
// The creature's race
#define RACE "beast"
