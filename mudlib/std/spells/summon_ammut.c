...
#define ID ({"ammut", "beast", "abomination"})
// The creature's short desc
#define SHORT "hideous ammut"
// The creature's long desc
#define LONG "This is a creature that has the head of a crocodile, the body of a lion, and the hindquarters of a hippopotamus. It looks as if it wants to eat your heart out."
// The creature's race
#define RACE "beast"
