...
#define NAME "hippocampus"
// The type of creature (sky, water, earth, fire, magic)
#define TYPE "water"
// The base MP cost
#define MPCOST 30
// The normal train dev cost
#define NORMALDEVCOST 85
// The fast train dev cost
#define FASTDEVCOST 220
// The spell's casting level
#define LEVEL 25
// The IDs of the creature
#define ID ({"hippocampus", "hippo", "beast"})
// The creature's short desc
#define SHORT "grey hippocampus"
// The creature's long desc
#define LONG "This creatre is half-horse and half-fish: its forepart is that of a horse and its hindquarters are that of a fish. It has two webbed at its forepart and a fin on the back of its neck. It hovers off the ground by magic so it can move."
// The creature's race
#define RACE "beast"
// The creature's body type
#define BODYTYPE "merperson"
// The type of crit damage the creature does in battle
#define MELEEDAMAGE "cold"
// The creature's level. Multiplies melee damage power (hence the name).
#define POWERMULTIPLIER 25
// The charge multiplier. SPELLPOWER*CHARGEMULTI=how many points of charge the animal gives to a jewel
#define CHARGEMULTIPLIER 25
