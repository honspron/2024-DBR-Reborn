...
void spell_func(object caster, object at, int power, string args, int flag) {
    ...
    if(args != "rotted zombie" && args != "blood hound" && args != "undead beast" && args != "zombie spirit" && args != "blood fiend" && args != "vampiric hound" && args != "red ghoul" && args != "essence warrior" && args != "chaos shadow" && args != "soul knight" && args != "gravewyrm" && args != "shadowflame templar" && args != "nether lord" && args != "death dragon") {
...
void finish_work(object caster, object at, int power) {
	...
	ob->add_wc(300, "aether");
	ob->add_wc(300, "cold");
	ob->add_wc(300, "crushing");
	ob->add_wc(300, "cutting");
	ob->add_wc(300, "unholy");
	ob->add_wc(300, "disruption");
	ob->add_wc(300, "electricity");
	ob->add_wc(300, "fire");
	ob->add_wc(300, "holy");
	ob->add_wc(300, "impact");
	ob->add_wc(300, "impaling");
	ob->add_wc(300, "infernal");
	ob->add_wc(300, "plasma");
	ob->add_wc(300, "stress");
	ob->add_wc(300, "strike");
	ob->add_wc(300, "vacuum");
	ob->set_enh_critical(6);
    }
    at->remove();
    ob->move(caster);
