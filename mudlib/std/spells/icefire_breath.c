...
set_property("damage types", ([ "cold" : 250+this_player()->query_level(), "cold #2" : 250+this_player()->query_level(), "fire" : 250+this_player()->query_level(), "fire #2" : 250+this_player()->query_level() ]));
