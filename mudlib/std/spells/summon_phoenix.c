...
#define ID ({"phoenix", "bird", "fire-bird"})
// The creature's short desc
#define SHORT "fiery phoenix"
// The creature's long desc
#define LONG "This Phoenix is big and feathery. He floats around, fire trailing him."
// The creature's race
