...
#define ID ({"wolf", "amarok", "dire wolf"})
// The creature's short desc
#define SHORT "big amarok"
// The creature's long desc
#define LONG "An amarok is a huge wolf. He has a furry grey coat, and big teeth."
// The creature's race
#define RACE "wolf"
