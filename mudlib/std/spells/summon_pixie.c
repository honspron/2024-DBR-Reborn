...
#define ID ({"pixie", "munchkin", "faerie"})
// The creature's short desc
#define SHORT "tiny pixie"
// The creature's long desc
#define LONG "Pixies are mischievous faerie creature no larger than your hand, having red hair, a turned-up nose, a wide mouth, green eyes, and a mischievous smile. This one wears a tight-fitting green suit. They often lead humans astray."
// The creature's race
#define RACE "sprite"
// The creature's body type
#define BODYTYPE "winged-humanoid"
// The type of crit damage the creature does in battle
#define MELEEDAMAGE "aether"
// The creature's level. Multiplies melee damage power (hence the name).
#define POWERMULTIPLIER 17
// The charge multiplier. SPELLPOWER*CHARGEMULTI=how many points of charge the animal gives to a jewel
#define CHARGEMULTIPLIER 17
