...
#define ID ({"alicanto", "bird"})
// The creature's short desc
#define SHORT "glowing alicanto"
// The creature's long desc
#define LONG "An alicanto is a nocturnal, flightless bird whose diet comprised solely of gold and silver. Alicanto are flightless due to their metallic diet, which also causes their wings to glow."
// The creature's race
#define RACE "bird"
