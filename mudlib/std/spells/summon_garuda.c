...
#define NORMALDEVCOST 125
// The fast train dev cost
#define FASTDEVCOST 295
// The spell's casting level
#define LEVEL 32
// The IDs of the creature
#define ID ({"garuda", "beast"})
// The creature's short desc
#define SHORT "scary garuda"
// The creature's long desc
#define LONG "The garuda has an eagle's beak and wings and a human body, with a white face, scarlet wings, and a golden body. The Garuda typically feed on evil beings."
// The creature's race
#define RACE "beast"
