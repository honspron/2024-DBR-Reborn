...
#define ID ({"bunyip", "seal", "beast"})
// The creature's short desc
#define SHORT "mean bunyip"
// The creature's long desc
#define LONG "This is a large, amphibious creature which looks kind of like a big walrus. It emits a harsh cry now and then. You've heard it eats people."
// The creature's race
#define RACE "beast"
// The creature's body type
#define BODYTYPE "quadruped"
