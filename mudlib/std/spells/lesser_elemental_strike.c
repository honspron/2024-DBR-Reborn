...
void create() {
    ::create();
    set_property("name","lesser elemental strike");
    set_property("skill","elementalism");
    set_property("casting time",6);
    set_property("base mp cost",23);
    set_property("dev cost",21);
    set_property("fast dev cost",67);
    set_property("spell level", 4);
    set_property("moon","warzau");
    set_property("caster message","You cast a lesser elemental strike!");
    set_property("target message","");
    set_property("observer message","$C casts a lesser elemental strike.");
    set_property("spell type",({ "damage" }));
    set_property("elemental spell", 1);
    set_property("must be present", 1);
    set_property("combat spell", 1);
    set_property("ele damage", 12+this_player()->query_level()/4);
    set_property("damage multiplier", 2+this_player()->query_level()/3);
...
void info() {
message("help",
"This spell is the equivalent of firing 4 lesser elemental bolts see 'help "
"spell lesser elemental bolt' at any number of targets.  You may fire all "
