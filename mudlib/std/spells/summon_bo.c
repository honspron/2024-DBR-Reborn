...
#define ID ({"bo", "unicorn", "tiger"})
// The creature's short desc
#define SHORT "sleek bo"
// The creature's long desc
#define LONG "A bo is a unicorn-like creature that possesses the teeth and claws of a tiger along with a white body and a black tail."
// The creature's race
#define RACE "beast"
