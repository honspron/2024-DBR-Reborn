...
#define ID ({"shony", "spirit"})
// The creature's short desc
#define SHORT "diabolical shony"
// The creature's long desc
#define LONG "Shonies are evil water spirits. They've been known to grab sailors thrown overboard their ships and eat them. You wonder why this one isn't in the water. He must be hungry."
// The creature's race
