...
#define NORMALDEVCOST 37
// The fast train dev cost
#define FASTDEVCOST 103
// The spell's casting level
#define LEVEL 7
// The IDs of the creature
#define ID ({"anka", "bird", "arctic bird"})
// The creature's short desc
#define SHORT "arctic anka"
// The creature's long desc
#define LONG "The anka is a giant arctic bird. At one point in time, the species was so numerous that it nearly crowded all other birds from the sky. Eventually, though, numbers decreased till it nearly became extinct."
// The creature's race
#define RACE "bird"
