...
#define ID ({"dracae", "spirit", "water spirit"})
// The creature's short desc
#define SHORT "devious dracae"
// The creature's long desc
#define LONG "Dracae are waters spirits of lochs and rivers that often leave treasure for lucky mortals. However, the only thing this one wants to do is kick your ass."
// The creature's race
#define RACE "beast"
