...
#define ID ({"hydra", "dragon"})
// The creature's short desc
#define SHORT "dangerous-looking hydra"
// The creature's long desc
#define LONG "Hydras are dragons that inhabit the water. They're not evil, per se, but don't mind munching on the odd elf or dwarf once in a while..."
// The creature's race
#define RACE "dragon"
