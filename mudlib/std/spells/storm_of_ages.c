...
set_property("damage types", ([ "disruption" : 100+this_player()->query_level(), "infernal" : 100+this_player()->query_level(), "unholy" : 100+this_player()->query_level() ]));
set_property("damage multiplier", 20+this_player()->query_level()*2);
