...
#define NORMALDEVCOST 67
// The fast train dev cost
#define FASTDEVCOST 170
// The spell's casting level
#define LEVEL 20
// The IDs of the creature
#define ID ({"harpy", "flying ho"})
// The creature's short desc
#define SHORT "horrifying harpy"
// The creature's long desc
#define LONG "This is a foul creature that has the head of an old woman and the body, wings, beak, and claws of a bird. They supposedly fly with the speed of the wind, have feathers that can not be pierced, and almost always travel in groups of three."
// The creature's race
#define RACE "beast"
// The creature's body type
#define BODYTYPE "fowl"
