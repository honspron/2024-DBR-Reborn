...
#define ID ({"pterippus", "flying ho"})
// The creature's short desc
#define SHORT "proud pterippus"
// The creature's long desc
#define LONG "Pterippi are winged horses, usually having leathery wings like that of a bird attached to their torsoes."
// The creature's race
#define RACE "beast"
