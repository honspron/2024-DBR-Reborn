...
#define ID ({"jinn", "man", "genie"})
// The creature's short desc
#define SHORT "floating jinn"
// The creature's long desc
#define LONG "A Jinn is rather like a genie - it's just that's a lot meaner, and enjoys fire more."
// The creature's race
#define RACE "human"
