...
void create() {
    ...
    set_property("damage types", ([ "electricity" : 30+this_player()->query_level(), "holy" : 30+this_player()->query_level() ]));
    set_property("damage multiplier", 7.5+this_player()->query_level() );
