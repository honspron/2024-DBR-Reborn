...
set_property("damage types", ([ "unholy" : 50+this_player()->query_level(), "unholy #2" : 50+this_player()->query_level(), "fire" : 50+this_player()->query_level(), "fire #2" : 50+this_player()->query_level() ]));
set_property("damage multiplier", 10+this_player()->query_level() );
