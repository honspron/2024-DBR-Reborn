...
#define NORMALDEVCOST 105
// The fast train dev cost
#define FASTDEVCOST 260
// The spell's casting level
#define LEVEL 27
// The IDs of the creature
#define ID ({"alan", "bird-man"})
// The creature's short desc
#define SHORT "graceful alan"
// The creature's long desc
#define LONG "Half-bird and half-human spirits that make their homes in forests but are also reputed to inhabit halls of gold. They sleep hanging upside-down because their fingers are on their feet and their toes on their hands. They are generally friendly towards humans."
// The creature's race
#define RACE "bird-man"
// The creature's body type
#define BODYTYPE "winged-humanoid"
// The type of crit damage the creature does in battle
#define MELEEDAMAGE "vacuum"
// The creature's level. Multiplies melee damage power (hence the name).
#define POWERMULTIPLIER 27
// The charge multiplier. SPELLPOWER*CHARGEMULTI=how many points of charge the animal gives to a jewel
#define CHARGEMULTIPLIER 27
