...
void create() {
    ...
    set_property("prereq", "master puissance");
...
void info() {
message("help",
"This spell adds an extreme deal of extra damage to a weapon.  The enchantment "
"limit for this spell is higher than that of master puissance.  "
...
"***This is a very powerful spell and only the most dedicated enchanters may use it. A skill of 170% is needed to cast this spell.\n"
...
void spell_func(object caster, object at, int power, string args, int flag) {
  ...
  if((int)caster->query_skill("enchantment") < 170 ) {
    message("info", "You need more enchantment to imbue extreme puissance.", caster);
    caster->add_mp(props["mp cost"]);
    remove();
    return;
  }
