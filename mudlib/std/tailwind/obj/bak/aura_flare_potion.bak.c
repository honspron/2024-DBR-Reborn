...
void create() {
   ...
   set_long("A small flask containing an aura flare potion. You can drink it, but it won't do anything... it needs magic activation.");
   set_weight(3);
   set_value(0);
}
...
int drink_func(string str) {
   ...
   if((!str) || ((str != "aura flare potion") && (str != "flare potion") && (str != "aura potion") && (str != "potion"))) {
