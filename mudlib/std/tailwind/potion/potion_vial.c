...
#define QC query_property("color")
...
void setup_poison(){
    set_short("a vial of "+QC+" liquid");
    set_name("a vial of "+QC+" liquid");
    set_long("The small vial contains a thick, "+QC+" liquid.");

}

void set_color(string str){
    set_property("color", str);
    setup_poison();
}
...
int potion_weapon(string str) {
    ...
    write("You apply a healing potion to your weapon, which doesn't do
anything.");
