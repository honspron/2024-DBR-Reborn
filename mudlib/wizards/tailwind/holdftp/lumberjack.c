// Modded by TW for new wood types
...
break;
case 51..75:
ob->set_material("wood/ridgewood");
break;
case 76..85:
ob->set_material("wood/bluewood");
break;
case 86..95:
ob->set_material("wood/icetree");
break;
case 96..99:
ob->set_material("wood/demontimber");
break;
}
  return;
}
