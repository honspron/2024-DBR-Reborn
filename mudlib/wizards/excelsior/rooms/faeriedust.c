...
set("short","The city entrance");
   set("long",@ext You have finally arrived at the legendary city of 
      ...
      you to enter a city of despair like a silent devil, ever vigilant, 
      ever evil. The buildings and towers are still there, but they don't  
      look that magnificent- though they still have a sturdy air about  
      them, things are so polluted and dirty it looks like the gods they  
      rivaled became jealous. 
...
ext);
   set_items( ([ "city": "The city looks to be very run down.", "gates":
    ...
    add_exit("/d/damned/virtual/room_13_6.world","out");  
